const CPU = [{
    ...
    price: 393600, socket: 1700, imgl: 'public\imgs\cpu.0.jpg' ,cnt : 1 , kinds : 'cpu'
},
{
    ...
    price: 221600, socket: 1200, imgl:'public\imgs\cpu.1.jpg',cnt : 0, kinds : 'cpu'
},
{
    ...
    price: 178220, socket: 1200, imgl: `public\imgs./cpu.2`,cnt : 0, kinds : 'cpu'
},
{
    ...
    price: 452350, socket: 'AM4', imgl: `public\imgs./cpu.3`,cnt : 0, kinds : 'cpu'
},
{
...
const SSD = [
    {
        ...
        stype: 'nvme', price: 63070, size: null, memo: null, imgl: `public\imgs./ssd.0}`,cnt : 1, kinds : 'ssd'
    },
    {
        id: 11, volume: 500, manu: 'samsung', title: '삼성전자 970 EVO Plus M.2 NVMe (500GB)', pcie: 3,
        stype: 'nvme', price: 98050, size: null, memo: true, imgl: `public\imgs./ssd.$1`,cnt : 0, kinds : 'ssd'
    },
    {
        id: 12, volume: 500, manu: 'samsung', title: '삼성전자 870 EVO (500GB)', pcie: null,
        stype: 'sata', price: 87330, size: 2.5, memo: true, imgl: `public\imgs./ssd.2`,cnt : 0, kinds : 'ssd'
    },
    {
        id: 13, volume: 500, manu: 'sk', title: 'SK하이닉스 Gold S31 (500GB)', pcie: 3,
        stype: 'nvme', price: 67410, size: null, memo: true, imgl: `public\imgs./ssd.3`,cnt : 0, kinds : 'ssd'
    }
]
